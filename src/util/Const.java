...
public class Const {
    ...
    public static final String QUERY_UPDATE_BOL = "UPDATE BILL_OF_LANDING SET PLACE_OF_LOADING_CODE=?,PLACE_OF_UNLOADING_CODE=? WHERE BOL_REFERENCE=? AND ID_GENERAL=?";
